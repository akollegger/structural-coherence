# RFC-006 — Enrichment-Only Noise Amplification

**Status:** Awaiting RFC. `proposals/RFC-006-enrichment-noise-amplification.md` has not been written yet.
**Source:** RFC-001 §8.4.
...
Freeze `proposals/RFC-006-enrichment-noise-amplification.md` first — it needs to specify
