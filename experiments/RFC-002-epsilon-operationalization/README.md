# RFC-002 — Operationalizing ε, and Coherence Decay Under Fixed Structure

**Status:** Awaiting RFC. `proposals/RFC-002-epsilon-operationalization.md` has not been written yet.
**Source:** RFC-001 §8.1.
...
This is the foundational experiment in the program — RFC-003 and RFC-004 both depend on
...
Do not start data collection until `proposals/RFC-002-epsilon-operationalization.md` is
