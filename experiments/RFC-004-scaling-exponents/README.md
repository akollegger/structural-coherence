# RFC-004 — The Scaling Exponents δ and γ, and Their Trajectories

**Status:** Awaiting RFC. `proposals/RFC-004-scaling-exponents.md` has not been written yet.
**Source:** RFC-001 §8.3.
**Feeds:** RFC-003 (§8.2), which uses these exponents for its domain-specific boundary test.
...
Freeze `proposals/RFC-004-scaling-exponents.md` first — it needs to specify the domain
