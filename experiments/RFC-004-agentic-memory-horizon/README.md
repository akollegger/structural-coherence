# RFC-004 — Structured Memory Over Task Horizon (Agentic Memory)

**Status:** Awaiting RFC. `proposals/RFC-004-agentic-memory-horizon.md` has not been written yet.
...
Freeze `proposals/RFC-004-agentic-memory-horizon.md` first — and freeze it only after
