# RFC-005 — Enrichment-Only Noise Amplification

**Status:** Awaiting RFC. `proposals/RFC-005-enrichment-noise-amplification.md` has not been written yet.
**Source:** RFC-001 §8.4.
...
Freeze `proposals/RFC-005-enrichment-noise-amplification.md` first — it needs to specify
