# RFC-007 — Structured Memory Over Task Horizon (Agentic Memory)

**Status:** Awaiting RFC. `proposals/RFC-007-agentic-memory-horizon.md` has not been written yet.
...
Freeze `proposals/RFC-007-agentic-memory-horizon.md` first — and freeze it only after
