# RFC-007 — The Programming-Language Gradient

**Status:** Awaiting RFC. `proposals/RFC-007-typescript-migration-gradient.md` has not been written yet.
**Source:** RFC-001 §8.5.
...
Freeze `proposals/RFC-007-typescript-migration-gradient.md` first — it needs to specify
