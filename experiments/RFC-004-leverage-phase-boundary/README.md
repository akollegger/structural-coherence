# RFC-004 — Leverage Growth and the Phase Boundary

**Status:** Awaiting RFC. `proposals/RFC-004-leverage-phase-boundary.md` has not been written yet.
**Source:** RFC-001 §8.2.
**Depends on:** RFC-005 (§8.3) for domain-specific $\delta$, $\gamma$ estimates — see note below.
...
worst case — needs $\delta$ and $\gamma$ estimates from RFC-005. Sequence accordingly, or
run both with the worst-case bound first and revisit once RFC-005 has results.
...
Freeze `proposals/RFC-004-leverage-phase-boundary.md` first — it needs to specify the
